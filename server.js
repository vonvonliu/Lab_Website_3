...
app.get('/player_info/post', function(req,res){
  ...
  if(player_id != "Select Player"){
    ...
    var games = 'SELECT COUNT(*) FROM football_games LEFT OUTER JOIN football_players ON ARRAY[football_players.id] <@ football_games.players WHERE football_players.id = ' + player_id + ';';
